...
export const registerUserService = async (userData) => {
    ...
    if (existingUser) {
        const message = existingUser.email === email ? 'Email already in use.' : 'Username already exists.';
...
export const refreshAccessTokenService = async (token) => {
    ...
    const newAccessTokenPayload = { id: user.id, username: user.username, role: user.role };
